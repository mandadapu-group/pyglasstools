#ifndef __POLYDISPERSE_18_H__
#define __POLYDISPERSE_18_H__
#include <vector>

class Polydisperse18
{
    public:
        ...
        */
        Polydisperse18(const double& _rsq, const double& _rcutsq, const std::vector<double>& _params)
