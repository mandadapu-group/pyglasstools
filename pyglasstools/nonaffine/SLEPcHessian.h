    ...
    public:
        ...
        void getAllEigenPairs_Mumps()
        {
            ...
            */
            ...
            ierr = PetscOptionsHasName(NULL,NULL,"-terse",&terse);CHKERRABORT(PETSC_COMM_WORLD,ierr);
            if (terse) 
            {
                ierr = EPSErrorView(eps,EPS_ERROR_RELATIVE,NULL);CHKERRABORT(PETSC_COMM_WORLD,ierr);
            } 
            else 
            {
